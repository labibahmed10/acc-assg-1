...
//   "name": "nicn",
//   "contact": 12332552,
//   "address": "banglaaaaaaaaaa",
//   "photoUrl": "https://cdn1.iconfinder.com/data/icons/random-115/24/person-512.png"
// }
...
module.exports.updateAUser = (req, res) => {
  ...
  if (!id || isNaN(id)) {
    return res.send({ status: 400, success: false, result: "Please provide a valid id you wants to update" });
  }
  if (!updateInfo) {
    return res.send({ status: 400, success: false, result: "Please provide user info" });
  }
